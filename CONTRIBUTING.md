...
Report bugs at https://github.com/force4760/quotedopai/issues.
...
quotedopai could always use more documentation, whether as part of the
...
Ready to contribute? Here's how to set up `quotedopai` for local development.

1. Fork the `quotedopai` repo on GitHub.
2. Clone your fork locally::
```bash
    $ git clone git@github.com:your_name_here/quotedopai.git
```
